...
<section>
    <div className="parallax-one">
      <div className="parallax-one-info" >
        <h4 id="ugg-3-h4" >Betelgeuse, spectral type M1-M2, the second-brightest in the constellation of Orion.</h4>
      </div>
      ...
      <div className="info-container" >
        <div className="info-div" >
          ...
          <div className="info-div" >
          <p id="purp" className="info-name">Light-years from the Sun</p>
          <p id="purp"  className="info-number" >500–600</p>
          <p id="purp"  className="info-info" >يد الجوزاء </p>
          </div>
          ...
          <div className="info-div" >
          <p id="purp" className="info-name">Surface gravity</p>
          <p id="purp" className="info-number" >-0.5cgs</p>
          <p id="purp" className="info-info" >Yad al-Jauzā'</p>
          </div>
